...
parser.add_argument('--n_workers', type=int, default=4, help='Number of cpu cores to use')
# parser.add_argument('--n_workers', type=int, default=2, help='Number of cpu cores to use')  # For Colab
...
# save your model after training or testing, saved model will have no .pt extension
...
# MAIN_DIR = '/content/deep-music-enhancer'  # For Colab

SAVE_SAMPLES = True     # saves an entire song created by the model

OUTPUT_DIR = os.path.join(MAIN_DIR, 'output')  # output directory is /deep-music-enhancer/output

TRAIN_DIRS = [  # training dataset should be placed in /deep-music-enhancer/datasets/DSD100/Mixtures/Dev
...
# TRAIN_DIRS = ['/content/deep-music-enhancer/datasets/DSD100/Mixtures/Dev']  # For Colab
TEST_DIRS = [os.path.join(MAIN_DIR, 'datasets', 'DSD100', 'Mixtures', 'Test')]  # test dataset should be placed in /deep-music-enhancer/datasets/DSD100/Mixtures/Test
# TEST_DIRS = ['/content/deep-music-enhancer/datasets/DSD100/Mixtures/Test']  # For Colab

MODEL_DIR = os.path.join(MAIN_DIR, OUTPUT_DIR, 'models')  # models are saved in /deep-music-enhancer/output/models
# MODEL_DIR = os.path.join(OUTPUT_DIR, 'models')  # For Colab
os.makedirs(MODEL_DIR, exist_ok=True)
GENERATION_DIR = os.path.join(MAIN_DIR, OUTPUT_DIR, 'generation', SAVE_NAME)  # generation is in /deep-music-enhancer/output/generation/XX
# GENERATION_DIR = os.path.join(OUTPUT_DIR, 'generation', SAVE_NAME)  # For Colab
